...
export class RangeSelection implements BaseSelection {
  ...
  formatText(formatType: TextFormatType): void {
    ...
    let firstNodeTextLength = firstNode.getTextContentSize();
    ...
    if (startOffset === firstNode.getTextContentSize()) {
      ...
      if ($isTextNode(nextSibling)) {
        ...
        startOffset = 0;
        firstNode = nextSibling;
        firstNodeTextLength = nextSibling.getTextContentSize();
...
function getCharacterOffset(point: PointType): number {
  ...
  return offset === parent.getChildrenSize() ? parent.getTextContentSize() : 0;
}
...
function internalResolveSelectionPoints(
  ...
  if (
    ...
    } else if (anchorOffset === resolvedAnchorNode.getTextContentSize()) {
